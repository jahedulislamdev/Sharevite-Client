         ...
         <div className="relative font-hind">
            ...
            <div className="absolute inset-0 bg-black/80 flex items-center">
               <div className="max-w-4xl px-6 md:px-16 space-y-4 md:space-y-6">
                  ...
                  {/* CTA Button */}
                  <div>
                     <button className="text-sm px-2 sm:px-4 md:px-6 py-2 sm:py-3 cursor-pointer  bg-green-600 hover:bg-green-700 text-white font-medium rounded shadow-lg transition-colors duration-300">
                        এখনই দান করুন
                     </button>
                  </div>
               </div>
